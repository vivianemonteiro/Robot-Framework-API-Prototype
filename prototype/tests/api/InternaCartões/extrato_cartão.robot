...
Consultar Extrato Válido
    ...
    ${user_id}=    Get User Token    user_id    password    

    ${resp}=    Extrato Cartão    ${user_id}    =xxxxxxxxxxx    =user_id    =2020-02-01    =2020-03-01

    Should Be Equal As Strings    ${resp.status_code}    200
    Should Be Equal As Strings    ${resp.text}           {"isSucesso":true,"resultado":{"numeroCartao":"xxxxxxxxxxx","produtoCartao":" 2.0","dataInicial":"2020-02-01T00:00:00","dataFinal":"2020-03-01T00:00:00","detalhes":[]}}
...
Consultar Extrato Informando o Cartão de Outro Usuário
    ...
    ${resp}=    Extrato Cartão    ${user_id}    =123456789    =user_id    =2020-02-01    =2020-03-01

    Should Be Equal As Strings    ${resp.status_code}    200
    Should Be Equal As Strings    ${resp.text}           {"isSucesso":false,"erros":[{"codigo":1,"mensagem":"Cartão 123456789 não cadastrado na base "}]}    
...
Consultar Extrato Informando o Cartão de Inválido
    ...
    ${resp}=    Extrato Cartão    ${user_id}    =123456789012    =user_id    =2020-02-01    =2020-03-01
...
Consultar Extrato Informando um CPF Inválido
    ...
    ${resp}=    Extrato Cartão    ${user_id}    =xxxxxxxxxxx    =12345678900    =2020-02-01    =2020-03-01
...
Consultar Extrato Informando o CPF de Outro Usuário
    ...
    ${resp}=    Extrato Cartão    ${user_id}    =xxxxxxxxxxx    =00000000000    =2020-02-01    =2020-03-01
...
Consultar Extrato Informando CPF e Cartão de Outro Usuário
    ...
    ${resp}=    Extrato Cartão    ${user_id}    =123456789    =12345678900    =2020-02-01    =2020-03-01
...
Consultar Extrato com Data Inicial Inválida
    ...
    ${resp}=    Extrato Cartão    ${user_id}    =xxxxxxxxxxx    =user_id    =2020-01-32    =2020-03-01
...
Consultar Extrato com Data Final Inválida
    ...
    ${resp}=    Extrato Cartão    ${user_id}    =xxxxxxxxxxx    =user_id    =2020-02-01    =2020-03-32
...
Consultar Extrato com Data Inicial e Final Inválida
    ...
    ${resp}=    Extrato Cartão    ${user_id}    =xxxxxxxxxxx    =user_id    =2020-01-32    =2020-03-32
...
Consultar Extrato sem Informar Número do Cartão
    ...
    ${resp}=    Extrato Cartão    ${user_id}    =${EMPTY}    =user_id    =2020-02-01    =2020-03-01
...
Consultar Extrato sem Informar Número do CPF
    ...
    ${resp}=    Extrato Cartão    ${user_id}    =xxxxxxxxxxx    =${EMPTY}    =2020-02-01    =2020-03-01
...
Consultar Extrato sem Informar Data Inicial
    ...
    ${resp}=    Extrato Cartão    ${user_id}    =xxxxxxxxxxx    =user_id    =${EMPTY}    =2020-03-01
...
Consultar Extrato sem Informar Data Final
    ...
    ${resp}=    Extrato Cartão    ${user_id}    =xxxxxxxxxxx    =user_id    =2020-02-01    =${EMPTY}
...
Consultar Extrato Sem Informar a Senha do Usuário
    ...
    ${user_id}=    Get User Token    user_id    ${EMPTY}    
