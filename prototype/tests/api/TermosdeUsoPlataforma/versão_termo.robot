...
#Retorna erro ao tentar consultar ambos os termos
Consultar Ambos os Termos
    ...
    Should Be Equal As Strings    ${resp.text}           {"message":"No HTTP resource was found that matches the request URI 'http://bunge.sit.integracao.pagbem.com.br/api/termosUso/versaoAtual/'."}
