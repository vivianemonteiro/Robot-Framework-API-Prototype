...
#Retorna lista com todos os motivos (positivos e negativos)
...
#Retorna lista com todos os motivos de positivos
Listar Apenas Motivos Positivos
...
#Retorna lista com todos os motivos negativos
Listar Apenas Motivos Negativos
...
#Retorna erro pois os foi solicitado os dois tipos de motivos ao mesmo tempo
...
#Retorna todos os motivos pois nenhum dos parâmetros está como true
Listar Todos os Motivos Informando os Parâmetros
